  ...
  module ViewHelpers
    module FormFieldHelper
      def input_field_for_column(f, field)
        ...
        when :integer
          return f.text_field field.field_name, class: 'normal-input', disabled: field.disabled, data: {behaviour: 'integer-only'}
        when :decimal
          return f.text_field field.field_name, class: 'normal-input', disabled: field.disabled, data: {behaviour: 'decimal-only'}
        when :string
          return f.text_field field.field_name, class: 'normal-input', disabled: field.disabled
        when :single_select
        ...
        when :date
          return f.text_field field.field_name, class: 'normal-input', disabled: field.disabled, data: {behaviour: 'date-only'}
        when :date_time
          return f.text_field field.field_name, class: 'normal-input', disabled: field.disabled, data: {behaviour: 'date-time'}
        when :text
